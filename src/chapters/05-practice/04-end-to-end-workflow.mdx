...
<ComparisonTable
  ...
  headers={['사례', '규모', '성과']}
  rows={[
    { feature: 'C 컴파일러 구축 (Anthropic)', values: ['16 Claude Opus 4.6 에이전트, 약 2,000 세션, $20K 비용', '100K줄 Rust 코드, Linux 6.9를 x86/ARM/RISC-V에서 컴파일 ([블로그](https://www.anthropic.com/engineering/building-c-compiler))'] },
