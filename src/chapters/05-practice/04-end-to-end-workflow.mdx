...
<ComparisonTable
  ...
  headers={['사례', '규모', '성과']}
  rows={[
    { feature: 'C 컴파일러 구축 (Anthropic)', values: ['16 에이전트, 2,000 세션, $20K 비용', '100K줄 Rust 코드, Linux 6.9 컴파일, GCC torture test 99% 통과'] },
    { feature: 'Ramp (핀테크)', values: ['30일간 전사 적용, 50% 주간 채택', '100만줄+ AI 코드, 인시던트 조사 시간 최대 80% 단축'] },
