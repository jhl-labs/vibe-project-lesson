...
<MermaidDiagram
  chart={`flowchart TB
    ...
    M --> A --> I --> S --> M
    style M fill:#1e3a5f,stroke:#38bdf8,color:#f1f5f9
    style A fill:#1e3a5f,stroke:#a78bfa,color:#f1f5f9
    style I fill:#1e3a5f,stroke:#34d399,color:#f1f5f9
    style S fill:#1e3a5f,stroke:#fbbf24,color:#f1f5f9`}
  title="MAIS 개선 사이클"
