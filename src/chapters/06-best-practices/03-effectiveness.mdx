...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: '팀 생산성 향상', values: ['62%의 팀이 25% 이상 생산성 향상을 보고', '2025 State of Engineering Management'] },
    { feature: '코드 리뷰 품질', values: ['AI 코드 리뷰 활용 팀의 81%가 품질 개선을 경험 (미사용 팀 55%)', 'DevTools Academy 2025'] },
    { feature: '테스트 신뢰도', values: ['AI 테스트 작성 활용 시 신뢰도 61% (미사용 시 27%)', 'Qodo 2025 State of AI Code Quality'] },
    { feature: '전체 코드 중 AI 비율', values: ['2025년 기준 전체 코드의 41%가 AI 도구로 작성 또는 보조', 'Stack Overflow 2025'] },
  ]}
/>
