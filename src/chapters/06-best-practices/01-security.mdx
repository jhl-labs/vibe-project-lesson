...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: 'A05', values: ['암호화 실패', '중간', '검증된 암호화 라이브러리 사용'] },
    { feature: 'A06', values: ['취약한 컴포넌트', '높음', '최신 안정 버전 유지'] },
    { feature: 'A07', values: ['인증 실패', '중간', '검증된 인증 라이브러리 사용'] },
    { feature: 'A08', values: ['인젝션', '높음', '파라미터화 쿼리, ORM 사용'] },
...
<Callout type="tip" title="Claude Code의 보안 지원">
  ...
  커밋 전 린트/보안 스캔을 Hook으로 설정하면 확실한 보안 검증이 가능합니다.
</Callout>
