...
**MCP(Model Context Protocol)**는 Anthropic이 2024년 말 공개한 **개방형 표준 프로토콜**로, AI 에이전트가 외부 도구 및 서비스와 **JSON-RPC 2.0** 기반으로 양방향 통신합니다. Claude Code뿐 아니라 Cursor, GitHub Copilot 등 주요 AI 코딩 도구가 MCP를 지원합니다.
