...
<MermaidDiagram
  chart={`flowchart TB
    ...
    ISSUE --> TRIAGE --> LB
    SCHED --> DOCSYNC --> SR
    style TRIGGER fill:#0f172a,stroke:#475569,color:#f1f5f9
    style CLAUDE fill:#1e293b,stroke:#818cf8,color:#f1f5f9
    style OUTPUT fill:#0f172a,stroke:#34d399,color:#f1f5f9`}
