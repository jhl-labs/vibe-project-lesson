...
`anthropics/claude-code-action`은 Anthropic이 공식 제공하는 GitHub Action으로, Claude Code의 능력을 GitHub 워크플로우에 직접 통합합니다. PR 리뷰, 이슈 분류, 코드 생성 등 다양한 작업을 자동화하며, 2025년 9월에 v1.0이 정식 출시되었습니다.
...
<DataTable
  ...
  data={[
    ...
    { option: 'model', required: '아니오', defaultVal: 'claude-sonnet-4-20250514', description: '사용할 Claude 모델' },
...
- **모델 선택**: 간단한 작업에는 `claude-sonnet-4-20250514`, 복잡한 작업에만 `claude-opus-4-20250514` 사용
