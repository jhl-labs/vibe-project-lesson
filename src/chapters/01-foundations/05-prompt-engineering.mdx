...
<ComparisonTable
  ...
  headers={['순서', '기법', '설명']}
  rows={[
    { feature: '1', values: ['Be clear and direct', '명확하고 직접적인 지시'] },
    { feature: '2', values: ['Use examples (multishot)', '예제를 통해 원하는 출력 형태 시연'] },
    { feature: '3', values: ['Let Claude think (CoT)', '단계별 사고를 유도하여 정확도 향상'] },
    { feature: '4', values: ['Use XML tags', 'XML 태그로 프롬프트 구조화'] },
    { feature: '5', values: ['Give Claude a role', '시스템 프롬프트로 역할 부여'] },
    { feature: '6', values: ['Chain complex prompts', '복잡한 작업을 여러 단계로 분할'] },
    { feature: '7', values: ['Long context tips', '긴 컨텍스트 처리 최적화'] },
  ]}
/>
...
# 2단계: Plan - 계획 수립 (Shift+Tab으로 Plan Mode 진입)
