...
| **Teams Standard** | $25/월/석 | 팀 관리 + 기본 사용 | Sonnet 4.5 |
| **Teams Premium** | $150/월/석 | 팀 관리 + 대량 사용 | 전체 모델 |
...
- **Agent SDK**: Claude Code의 에이전트 기능을 외부 애플리케이션에서 사용할 수 있는 SDK. TypeScript와 Python 지원
