...
<ComparisonTable
  ...
  headers={['사례', '규모', '성과']}
  rows={[
    { feature: 'C 컴파일러 구축 (Anthropic)', values: ['16 에이전트, 2,000 세션', '100K줄 코드, Linux 6.9 컴파일, GCC 99% 통과'] },
    { feature: 'Ramp (핀테크 유니콘)', values: ['30일간 전사 적용', '100만줄+ AI 코드, 인시던트 조사 시간 80% 감소'] },
    { feature: 'Anthropic 보안팀 내부', values: ['일상 업무 적용', '프로덕션 이슈 해결 10-15분 → 5분'] },
    { feature: 'Anthropic 마케팅팀', values: ['광고 자동화', '수백 개 광고 처리 수시간 → 수분'] },
  ]}
/>
