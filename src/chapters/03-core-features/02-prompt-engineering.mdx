...
Claude Code는 터미널에서 자연어로 지시하는 도구입니다. "좋은 코드를 얻는 것"은 "좋은 지시를 내리는 것"에서 시작합니다. [Anthropic 공식 문서](https://platform.claude.com/docs/en/docs/build-with-claude/prompt-engineering/overview)에서는 프롬프트 엔지니어링 기법을 **가장 범용적인 것부터 전문적인 것** 순서로 시도할 것을 권장합니다.
...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: '"ultrathink" (스킬 내 사용)', values: ['스킬 내에서 extended thinking 활성화', '스킬 본문에 포함하여 깊은 사고 유도'] },
