...
<Meta title="Part 2: 프로젝트 설정/문서 템플릿" />
...
- 가용성: 99.95% (연간 다운타임 약 4시간 23분 이하)
...
## Coverage Summary
- 전체 요구사항: 6개 (Must: 5, Should: 1)
- 매핑된 테스트: 8개
- 커버리지: 100% (모든 요구사항에 최소 1개 테스트)
- 자동화율: 75% (6/8, E2E 2건은 수동)
...
<ChapterNav
  prev={{ title: '가이드라인', path: '/docs/part-2--프로젝트-설정-가이드라인' }}
  next={{ title: '커맨드와 스킬', path: '/docs/part-3--핵심-기능-커맨드와-스킬' }}
/>
