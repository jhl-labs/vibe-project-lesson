  ...
  data={[
    {
      name: 'Enterprise 정책',
      type: 'folder',
      description: '조직 전체 (macOS: /Library/Application Support/ClaudeCode/, Linux: /etc/claude-code/)',
      children: [
...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: '조건부 적용', values: ['paths 프론트매터', '.instructions.md (applyTo)', 'globs 패턴', 'no'] },
    { feature: '임포트 구문', values: ['@path/to/file', 'no', '@file 구문', 'no'] },
