...
<Callout type="info" title="핵심 포인트">
  ...
  2025년 한 해 동안 **300개 이상의 버전 업데이트**가 배포되었습니다 ([npm registry](https://www.npmjs.com/package/@anthropic-ai/claude-code) 기준).
</Callout>
...
| **Teams Standard** | $25/월/석 (연간) | 팀 관리 + 기본 사용량 | Sonnet 4.5 |
| **Teams Premium** | $150/월/석 (연간) | 팀 관리 + Claude Code 포함 + 대량 사용 | 전체 모델 |
| **API** | 종량제 | 무제한 (비용 비례) | 전체 모델 |

<Callout type="tip" title="비용 참고">
  [Anthropic 공식 문서](https://code.claude.com/docs/costs)에 따르면 Claude Code 사용자의 평균 비용은 **하루 $6**, 90%의 개발자가 **하루 $12 이하**입니다.
