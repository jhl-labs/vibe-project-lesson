...
<Callout type="info" title="핵심 원칙">
  ...
  간단한 리팩토링에 Opus 4.8을 사용하는 것은 비효율적이고,
...
<Timeline
  ...
  events={[
    ...
    },
    {
      date: '2026년 2월',
      title: 'Opus 4.6 출시',
      description: '1M 컨텍스트(베타), Adaptive Thinking 도입. 128K 출력 토큰.',
    },
    {
      date: '2026년 2월',
      title: 'Sonnet 4.6 출시',
      description: 'SWE-bench 79.6%. Opus 4.6에 근접한 성능을 Sonnet 가격($3/$15)으로 제공. 1M 컨텍스트(베타) 지원.',
    },
    {
      date: '2026년 4월',
      title: 'Opus 4.7 출시',
      description: 'SWE-bench Verified 87.6% 달성. 1M 컨텍스트 정식 지원과 효율 개선.',
    },
    {
      date: '2026년 5월 28일',
      title: 'Opus 4.8 출시 (현재 기본/최강)',
      description: 'SWE-bench Verified 88.6%. effort 기본값 high, /effort xhigh 단계 도입. 1M 컨텍스트, 128K 출력, Dynamic workflows와 함께 도입.',
      highlight: true,
    },
  ]}
/>
...
<ComparisonTable
  ...
  headers={['항목', 'Opus 4.8', 'Sonnet 4.6', 'Haiku 4.5', 'Opus 4.5 (레거시)', 'Sonnet 4.5 (레거시)']}
  rows={[
    { feature: '모델 ID', values: ['claude-opus-4-8', 'claude-sonnet-4-6', 'claude-haiku-4-5', 'claude-opus-4-5-20251101', 'claude-sonnet-4-5-20250929'] },
    { feature: '출시일', values: ['2026년 5월', '2026년 2월', '2025년 10월', '2025년 11월', '2025년 9월'] },
    { feature: '컨텍스트 윈도우', values: ['1M', '200K (1M 베타)', '200K', '200K', '200K (1M 베타)'] },
    { feature: '최대 출력', values: ['128,000 토큰', '64,000 토큰', '64,000 토큰', '64,000 토큰', '64,000 토큰'] },
    { feature: '입력 가격 (/1M 토큰)', values: ['$5', '$3', '$1', '$5', '$3'] },
    { feature: '출력 가격 (/1M 토큰)', values: ['$25', '$15', '$5', '$25', '$15'] },
    { feature: '기본 effort', values: ['high', '-', '-', '-', '-'] },
    { feature: '지식 컷오프', values: ['Jan 2026', '-', '-', '-', '-'] },
    { feature: 'Adaptive Thinking', values: ['yes', 'yes', 'no', 'no', 'no'] },
    { feature: 'Extended Thinking', values: ['yes', 'yes', 'yes', 'yes', 'yes'] },
    { feature: 'Interleaved Thinking', values: ['yes', 'yes', 'yes', 'yes', 'yes'] },
    { feature: '강점', values: ['최강 추론, 1M 컨텍스트, xhigh effort', 'Opus급 성능, Sonnet 가격, 컴퓨터 사용', '빠른 속도, 저비용', '깊은 추론, 아키텍처', '균형 잡힌 성능'] },
  ]}
/>

<Callout type="tip" title="가격 출처">
  모든 가격은 [Anthropic 공식 가격 페이지](https://platform.claude.com/docs/en/about-claude/pricing) 기준입니다.
  현재 기본/최강 모델인 Opus 4.8은 입력 $5 / 출력 $25($/1M 토큰)로, 이전 세대 Opus(Claude 3 Opus / Opus 4.1: $15/$75) 대비 크게 인하된 가격을 유지합니다.
</Callout>
...
### Opus 4.8 — 현재 기본/최강 모델

Opus 4.8(`claude-opus-4-8`, 2026년 5월 28일 출시)은 Claude 모델 패밀리에서 **가장 강력한 추론 능력**을 가진 현행 플래그십이자 기본 모델입니다.

**핵심 특성:**
- **1M 토큰 컨텍스트**: 대규모 코드베이스 전체를 한번에 분석 가능
- **128K 출력 토큰**: 복잡한 코드를 한 번의 응답으로 완성
- **effort 기본값 high**: 모든 표면에서 기본적으로 높은 사고 깊이로 동작
- **/effort xhigh**: 최고 난도 작업을 위한 추가 effort 단계 제공
- **Adaptive Thinking**: 작업 복잡도에 따라 사고 깊이를 자동 조절
- **SWE-bench Verified 88.6%** ([Vellum](https://www.vellum.ai/blog/claude-opus-4-8-benchmarks-explained), Anthropic 보고)

<Callout type="info" title="Opus 4.8의 진정한 강점">
  Opus 4.8은 effort가 기본 `high`로 설정되어 별도 튜닝 없이도 깊은 추론을 수행합니다.
  아키텍처 설계, 보안 분석, 복잡한 디버깅처럼 최고 난도 작업에는 **`/effort xhigh`**로
  사고 깊이를 한 단계 더 끌어올릴 수 있습니다. 1M 컨텍스트와 결합해 대규모 작업의 정점에 위치합니다.
</Callout>
...
### Sonnet 4.6 — Opus급 성능, Sonnet 가격

Sonnet 4.6은 Opus 4.6 출시 12일 후인 **2026년 2월 17일**에 공개되었습니다. Opus 4.6의 97-99% 수준 성능을 **5분의 1 가격**으로 제공하여, 비용 대비 성능의 새로운 기준을 수립했습니다. ([Anthropic](https://www.anthropic.com/news/claude-sonnet-4-6))

**핵심 특성:**
- **SWE-bench 79.6%**: Opus 4.6(80.8%)에 근접한 코딩 성능
- **OSWorld 72.5%**: 컴퓨터 사용 능력이 Sonnet 4.5(61.4%) 대비 18% 향상
- **1M 토큰 컨텍스트 (베타)**: API를 통해 100만 토큰 컨텍스트 사용 가능
- **Adaptive Thinking**: Opus 4.6과 동일한 적응형 사고 지원
- **Sonnet 가격**: 입력 $3/출력 $15로 Sonnet 4.5와 동일한 가격 유지

**적합한 시나리오:**
- Opus급 품질이 필요하지만 비용을 절감하고 싶을 때
- 일상적인 기능 구현, 코드 리뷰, 테스트 작성
- 컴퓨터 사용(Computer Use) 기반 자동화
- 금융 분석, 지식 업무 (GDPval-AA에서 Opus 4.6을 능가)

<Callout type="tip" title="Sonnet 4.6 선호도">
  Claude Code 초기 테스트에서 사용자가 Sonnet 4.5보다 Sonnet 4.6을 약 **70% 선호**했고,
  Opus 4.5보다도 **59% 선호**했습니다 (출처: [Anthropic](https://www.anthropic.com/news/claude-sonnet-4-6), 2026.02.17).
  최고 난도 추론이 필요하지 않은 대부분의 작업에서 Sonnet 4.6은 최적의 선택입니다.
</Callout>

### Sonnet 4.5 — 검증된 균형의 마스터

Sonnet 4.5는 Sonnet 4.6 출시 이전까지 **Claude Code에서 가장 많이 사용된 모델**이었습니다. 여전히 안정적이고 검증된 선택지이며, Sonnet 4.6으로의 전환이 완료되지 않은 환경에서 계속 활용됩니다.

**핵심 특성:**
- **SWE-bench 77.2%**: 높은 코딩 성능
- **비용 효율**: Opus 대비 40% 저렴한 출력 비용
- **빠른 응답**: Opus 대비 빠른 응답 속도로 개발 흐름 유지
- **범용성**: 코딩, 리뷰, 문서화, 테스트 등 모든 작업에 적합

<Callout type="info" title="Sonnet 4.5에서 4.6으로 전환">
  Sonnet 4.6은 Sonnet 4.5와 동일한 가격이므로, 특별한 이유가 없다면 Sonnet 4.6으로 전환하는 것을 권장합니다.
  기존 프롬프트와 워크플로우는 대부분 호환되며, 코딩과 컴퓨터 사용 성능이 크게 향상됩니다.
</Callout>
...
<ComparisonTable
  ...
  rows={[
    { feature: 'Opus 4.8', values: ['88.6%', '높음', '현행 최강. 1M 컨텍스트, 128K 출력 ([Vellum](https://www.vellum.ai/blog/claude-opus-4-8-benchmarks-explained))'] },
    { feature: 'Opus 4.7', values: ['87.6%', '높음', '직전 세대 플래그십 (Anthropic 보고)'] },
    { feature: 'Opus 4.6 (레거시)', values: ['80.8%', '높음', '128K 출력, Adaptive Thinking ([Anthropic](https://www.anthropic.com/news/claude-opus-4-6))'] },
    { feature: 'Opus 4.5 (레거시)', values: ['80.9%', '높음', '80% 임계값 돌파한 첫 모델'] },
    { feature: 'Sonnet 4.6', values: ['79.6%', '중간', 'Opus급 성능, Sonnet 가격. 비용 대비 최고 효율 ([Anthropic](https://www.anthropic.com/news/claude-sonnet-4-6))'] },
    { feature: 'Sonnet 4.5 (레거시)', values: ['77.2%', '중간', '검증된 안정성. 이전 세대 Sonnet'] },
...
<Callout type="info" title="벤치마크 점수 주의">
  SWE-bench Verified 점수는 측정 방식/평가 하네스에 따라 달라질 수 있습니다.
  표의 값은 각 모델 출시 시점의 Anthropic 보고 및 공개 분석 기준이며,
  세대 간 직접 비교 시 측정 조건 차이를 감안하세요.
</Callout>

### 다중 벤치마크 종합 비교

<ComparisonTable
  title="주요 벤치마크 종합 비교 (2026년 6월 기준)"
  headers={['벤치마크', 'Opus 4.8', 'Sonnet 4.6', 'Haiku 4.5', '측정 영역']}
  rows={[
    { feature: 'SWE-bench Verified', values: ['88.6%', '79.6%', '73.3%', '실제 GitHub 이슈 해결'] },
    { feature: 'GPQA Diamond', values: ['91.3%+', '89.9%', '-', '대학원 수준 과학/수학'] },
    { feature: 'MATH-500', values: ['97.6%+', '97.8%', '-', '수학 문제 풀이'] },
    { feature: 'tau2-bench Retail', values: ['91.9%+', '91.7%', '-', '에이전트 도구 사용 (소매)'] },
    { feature: 'tau2-bench Telecom', values: ['99.3%+', '97.9%', '-', '에이전트 도구 사용 (통신)'] },
    { feature: 'OSWorld-Verified', values: ['72.7%+', '72.5%', '-', '컴퓨터 사용 (데스크톱 자동화)'] },
  ]}
/>

<Callout type="info" title="벤치마크 해석 주의사항">
  벤치마크 점수는 모델 역량의 한 측면만 보여줍니다. 실제 개발 환경에서는 **컨텍스트 관리, 도구 사용 패턴,
  응답 일관성** 등이 더 중요할 수 있습니다. Opus 4.8의 SWE-bench Verified 88.6%는 Anthropic 보고 기준이며
  ([Vellum](https://www.vellum.ai/blog/claude-opus-4-8-benchmarks-explained)), 일부 항목은 직전 세대 대비 동등 이상으로 표기했습니다(측정 하네스에 따라 변동 가능).
</Callout>

---

## Adaptive Thinking (적응형 사고) — Opus 4.8

### Extended Thinking에서 Adaptive Thinking으로

Claude 4 시리즈는 **Extended Thinking** 기능으로 복잡한 문제에서 단계별 사고 과정을 거쳐 정확도를 높였습니다. 현행 플래그십 Opus 4.8은 이를 발전시킨 **Adaptive Thinking**을 기본 탑재하며, effort 기본값이 `high`로 설정됩니다.

<ComparisonTable
  title="Extended Thinking vs Adaptive Thinking"
  headers={['항목', 'Extended Thinking (4.5)', 'Adaptive Thinking (4.8)']}
  rows={[
    { feature: '사고 깊이 조절', values: ['수동 (budget_tokens 지정)', '자동 (thinking: {type: "adaptive"})'] },
    { feature: '컨텍스트 윈도우', values: ['200K', '1M'] },
    { feature: '최대 출력', values: ['64K 토큰', '128K 토큰'] },
    { feature: 'Effort 파라미터', values: ['3단계 (low/medium/high)', '4단계 (low/medium/high/xhigh, 기본 high)'] },
...
<Callout type="tip" title="Extended Thinking 문서">
  ...
  Opus 4.8의 Adaptive Thinking은 [Adaptive Thinking 문서](https://platform.claude.com/docs/en/build-with-claude/adaptive-thinking)를 참조하세요.
</Callout>

### Effort 파라미터 (기본 high)

Opus 4.8의 Adaptive Thinking은 **Effort 파라미터**를 통해 사고 깊이를 제어합니다. 모든 표면에서 **기본값이 `high`**이며, 최고 난도 작업을 위해 **`/effort xhigh`** 단계가 추가되었습니다. Claude Code에서는 이것이 자동으로 적용되지만, API 사용 시 명시적으로 설정할 수 있습니다.
...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: 'High (●, 기본값)', values: ['거의 항상 사고', '보통', '높음', '복잡한 디버깅, 새 기능 설계, 아키텍처'] },
    { feature: 'xhigh (◉)', values: ['최대 깊이 사고', '느림', '최고', '최고 난도 아키텍처/보안 분석, 대규모 추론'] },
  ]}
/>

<CodeBlock
  code={`# API에서 Effort 파라미터 설정 예시 (Opus 4.8 Adaptive Thinking)
import anthropic
...
# 최고 난도 작업: xhigh effort (기본값은 high)
...
<Callout type="tip" title="Claude Code의 Effort 조절">
  Claude Code에서는 Opus 4.8의 Adaptive Thinking이 자동으로 작동하며, effort 기본값은 `high`입니다.
  `/model` 명령어에서 좌/우 화살표키로 effort 슬라이더를 조절하거나,
  최고 난도 작업에는 **`/effort xhigh`**로 사고 깊이를 한 단계 더 올릴 수 있습니다.
  effort 단계는 low/medium/high/xhigh이며, 기본값은 high입니다.
</Callout>
...
<ComparisonTable
  ...
  rows={[
    { feature: '멀티 에이전트 오케스트레이션', values: ['Opus 4.8', '1M 컨텍스트, Dynamic workflows'] },
    { feature: '대규모 코드베이스 분석', values: ['Opus 4.8', '1M 컨텍스트, 적응형 사고'] },
    { feature: '아키텍처 설계/리팩토링', values: ['Opus 4.8 (xhigh effort)', '깊은 추론 능력, 복잡한 의존성 분석'] },
    { feature: '디버깅 (복잡한 버그)', values: ['Opus 4.8 (xhigh effort)', '다단계 추론, 근본 원인 분석'] },
    { feature: '보안 취약점 분석', values: ['Opus 4.8', '오픈소스에서 500개 이상 제로데이 발견 실적, 최고 수준의 추론'] },
    { feature: '새 기능 구현', values: ['Sonnet 4.6', '성능과 비용의 균형'] },
    { feature: '코드 리뷰', values: ['Sonnet 4.6', '충분한 추론 + 합리적 비용'] },
    { feature: '테스트 작성', values: ['Sonnet 4.6', '패턴 인식 + 빠른 응답'] },
    { feature: 'API 엔드포인트 구현', values: ['Sonnet 4.6', '구조화된 코드 생성에 최적'] },
...
<MermaidDiagram
  chart={`flowchart TD
    ...
    Q1 -->|Yes| Opus48["Opus 4.8\n1M 컨텍스트"]
    Q1 -->|No| Q2{"대규모 코드베이스\n100K줄 이상 분석?"}
    Q2 -->|Yes| Opus48_2["Opus 4.8\n1M 컨텍스트"]
    Q2 -->|No| Q3{"복잡한 추론이\n필요한 작업인가?"}
    Q3 -->|Yes| Q4{"보안 분석 또는\n아키텍처 설계인가?"}
    Q4 -->|Yes| Opus48_3["Opus 4.8\nxhigh effort"]
    Q4 -->|No| Opus48_4["Opus 4.8\n깊은 추론"]
    Q3 -->|No| Q5{"비용과 품질의\n균형이 중요한가?"}
    Q5 -->|Yes| Sonnet["Sonnet 4.6\n균형 최적"]
    Q5 -->|No| Q6{"빠른 속도와\n낮은 비용이 우선?"}
    Q6 -->|Yes| Haiku["Haiku 4.5\n속도 우선"]
    Q6 -->|No| Sonnet2["Sonnet 4.6\n기본 선택"]
    ...
    style Opus48 fill:#fdf2ee,stroke:#c4613e,color:#2d2a26
    style Opus48_2 fill:#fdf2ee,stroke:#c4613e,color:#2d2a26
    style Opus48_3 fill:#fdf2ee,stroke:#c4613e,color:#2d2a26
    style Opus48_4 fill:#fdf2ee,stroke:#da7756,color:#2d2a26
...
<CodeBlock
  code={`# 긴급 프로덕션 버그 — Opus 4.8 (xhigh effort)
claude --model opus
/effort xhigh
...
# Opus 4.8의 Adaptive Thinking은 기본 high effort로 동작하며, xhigh로 더 깊게 추론
...
claude --model opus     # 최신 Opus (현재 4.8)
claude --model sonnet   # Sonnet 4.6 (최신 Sonnet)
claude --model haiku    # Haiku 4.5 (최신 Haiku)

# 2. 특정 버전 지정
claude --model claude-opus-4-8
claude --model claude-sonnet-4-6
claude --model claude-opus-4-5-20251101   # 레거시
claude --model claude-sonnet-4-5-20250929 # 레거시
...
<ComparisonTable
  title="모델별 토큰 비용 상세"
  headers={['비용 항목', 'Opus 4.8', 'Sonnet 4.6', 'Sonnet 4.5', 'Haiku 4.5', '비고']}
  rows={[
    { feature: '입력 (/1M 토큰)', values: ['$5.00', '$3.00', '$3.00', '$1.00', '프롬프트, 컨텍스트'] },
    { feature: '출력 (/1M 토큰)', values: ['$25.00', '$15.00', '$15.00', '$5.00', '응답, 코드 생성'] },
    { feature: '캐시 쓰기 (/1M 토큰)', values: ['$6.25', '$3.75', '$3.75', '$1.25', '입력 비용의 125%'] },
    { feature: '캐시 읽기 (/1M 토큰)', values: ['$0.50', '$0.30', '$0.30', '$0.10', '입력 비용의 10%'] },
    { feature: 'Batch API (/1M 출력)', values: ['$12.50', '$7.50', '$7.50', '$2.50', '출력 비용의 50%'] },
  ]}
/>
...
<ComparisonTable
  ...
  headers={['작업', '입력 토큰', '출력 토큰', 'Opus 4.8', 'Sonnet 4.6', 'Haiku 4.5']}
  rows={[
...
<Callout type="warning" title="Extended Thinking 비용">
  ...
  Opus 4.8 + xhigh effort로 복잡한 아키텍처 분석을 할 경우,
...
# Sonnet 4.6 기본, 가끔 Opus 사용
# 예상: $30-80/월 → Pro($20)/Max 5x($100) 추천

# 일반 개발자 (하루 30-50회 요청)
# Sonnet 4.6 + 주 2-3회 Opus 사용
...
# Opus 4.8: 50K 입력 = $0.25 + 캐시 쓰기 $0.0625 = $0.3125

# 후속 요청: 캐시 읽기로 90% 절감
# Opus 4.8: 50K 캐시 읽기 = $0.025 (기존 $0.25의 10%)
...
<ComparisonTable
  ...
  rows={[
    { feature: 'Pro ($20/월)', values: ['$20 고정', 'Sonnet 4.6 기본, 제한적', '가벼운 사용, 개인 프로젝트'] },
...
### Haiku로 탐색, Sonnet 4.6으로 구현, Opus로 검증
...
<MermaidDiagram
  ...
  caption="Haiku(탐색) → Sonnet 4.6(구현) → Opus(검증) → Haiku(정리)의 4단계 전환"
/>
...
<ComparisonTable
  ...
  headers={['단계', 'All Opus 4.8', '하이브리드 전략', '절감률']}
  rows={[
    { feature: '탐색 (5K in + 2K out)', values: ['$0.075', '$0.007 (Haiku)', '90%'] },
    { feature: '설계 (10K in + 5K out)', values: ['$0.175', '$0.175 (Opus)', '0%'] },
    { feature: '구현 (20K in + 10K out)', values: ['$0.350', '$0.210 (Sonnet 4.6)', '40%'] },
    { feature: '테스트 (10K in + 5K out)', values: ['$0.175', '$0.105 (Sonnet 4.6)', '40%'] },
...
### Opus 4.8 사용 시점
- 아키텍처 설계 및 대규모 리팩토링 (xhigh effort)
- 보안 취약점 분석
- 복잡한 동시성/성능 버그 디버깅
- 멀티 에이전트 오케스트레이션이 필요한 대규모 작업
...
<ComparisonTable
  ...
  headers={['항목', 'Anthropic API 직접', 'AWS Bedrock', 'Google Vertex AI', 'Microsoft Foundry']}
  rows={[
    { feature: '인증 방식', values: ['API 키', 'IAM 역할', '서비스 계정', 'Azure 자격증명'] },
    { feature: '데이터 경유', values: ['Anthropic 서버', 'AWS 인프라', 'GCP 인프라', 'Microsoft 인프라'] },
    { feature: '최신 모델 지원', values: ['출시 즉시', '1-2주 지연', '1-2주 지연', '1-2주 지연'] },
    { feature: 'Opus 4.8 컨텍스트', values: ['1M', '플랫폼별 상이', '플랫폼별 상이', '200K'] },
    { feature: 'ZDR 지원', values: ['가능 (별도 계약)', '기본 적용', '기본 적용', '기본 적용'] },
    { feature: '컴플라이언스', values: ['SOC 2', 'SOC 2, HIPAA, FedRAMP', 'SOC 2, HIPAA', 'SOC 2, HIPAA'] },
    { feature: '가격', values: ['표준 가격', '20-30% 추가', '20-30% 추가', '20-30% 추가'] },
    { feature: '사용량 대시보드', values: ['Anthropic Console', 'AWS CloudWatch', 'GCP Monitoring', 'Azure Monitor'] },
  ]}
/>

<Callout type="warning" title="엔터프라이즈 모델 선택 시 주의">
  AWS Bedrock, Google Vertex AI, Microsoft Foundry를 사용하면 데이터가 Anthropic 서버를 경유하지 않아
  보안/컴플라이언스 요구사항을 충족하기 쉽습니다. 다만 최신 모델(Opus 4.8 등)의
  지원이 1-2주 지연될 수 있고, Microsoft Foundry에서 Opus 4.8은 200K 컨텍스트로 제공되므로,
  팀에서 최신 기능이나 1M 컨텍스트가 필요한 경우 이를 고려하세요.
</Callout>
...
<ComparisonTable
  title="주요 AI 코딩 모델 비교 (2026년 6월 기준)"
  headers={['모델', 'SWE-bench', '컨텍스트', '강점', '약점']}
  rows={[
    { feature: 'Claude Opus 4.8', values: ['88.6%', '1M', '현행 최강 추론, Adaptive Thinking, xhigh effort, 보안 분석', '비용이 높음'] },
    { feature: 'Claude Sonnet 4.6', values: ['79.6%', '200K (1M 베타)', 'Opus급 성능, Sonnet 가격, 컴퓨터 사용', '최고 난도 추론은 Opus 대비 부족'] },
    { feature: 'Claude Opus 4.5 (레거시)', values: ['80.9%', '200K', '단일 세션 깊은 추론, 아키텍처', '구세대'] },
    { feature: 'Claude Sonnet 4.5 (레거시)', values: ['77.2%', '200K (1M 베타)', '검증된 안정성', 'Sonnet 4.6에 의해 대체'] },
...
# 4. 긴 컨텍스트 처리 (Opus 4.8: 1M)
# → 대규모 코드베이스 전체를 한번에 분석

# 5. 멀티 에이전트 오케스트레이션 (Opus 4.8 Dynamic workflows)
# → 복잡한 작업을 여러 서브에이전트로 분할 처리`}
  language="text"
...
# 2. Sonnet 4.6 최적 프롬프트: 구체적 요구사항 명시
...
<ComparisonTable
  ...
  rows={[
    { feature: 'Opus 4.8', values: ['과잉 엔지니어링 (불필요한 추상화, 패턴 추가)', 'CLAUDE.md에 "과도한 엔지니어링 금지" 명시'] },
    { feature: 'Opus 4.5 (레거시)', values: ['응답이 너무 길어짐 (설명 과다)', '"핵심만 간결하게" 지시 추가'] },
    { feature: 'Sonnet 4.6', values: ['복잡한 의존성 분석에서 간혹 실수', '의존성이 많으면 Opus로 전환'] },
    { feature: 'Haiku 4.5', values: ['복잡한 비즈니스 로직 누락', '복잡한 로직은 Sonnet 이상 사용'] },
  ]}
/>

<Callout type="warning" title="Opus 모델 과잉 설계 주의">
  Opus 계열(4.8 포함)은 불필요한 추상화나 추가 파일을 생성하는 경향이 있습니다.
...
CLAUDE_COMPLEX_MODEL=claude-opus-4-8
...
# 3. 모델 별칭 사용 (버전 고정 대신)
claude --model opus    # 항상 최신 Opus (현재 4.8)
...
| 상황 | 모델 | 근거 |
|------|------|------|
| "잘 모르겠다" | Sonnet 4.6 | 비용 대비 우수, 대부분의 작업에서 최적 |
| "이건 정말 복잡하다" | Opus 4.8 (xhigh effort) | 현행 최강 추론, 복잡한 의존성 분석 |
| "대규모 코드베이스를 다룬다" | Opus 4.8 | 1M 컨텍스트, Dynamic workflows |
| "빠르게 많이 처리해야 한다" | Haiku 4.5 | 최저 비용, 최고 속도 |
| "보안 분석이 필요하다" | Opus 4.8 | 오픈소스 500개 이상 제로데이 발견 실적 |
| "비용을 최소화하고 싶다" | 하이브리드 전략 | 단계별 모델 전환 |

### 모델 선택의 황금 규칙

<Callout type="tip" title="세 가지 황금 규칙">
  1. **의심스러우면 Sonnet 4.6**: 대부분의 작업에서 Opus급 성능을 합리적 가격에 제공합니다.
  2. **복잡한 추론은 Opus 4.8**: 아키텍처 설계, 보안 분석, 복잡한 디버깅에는 Opus 4.8을 사용하고, 최고 난도에는 `/effort xhigh`를 활용하세요.
  3. **반복 작업은 Haiku**: 보일러플레이트, 문서화, 간단한 수정에는 Haiku로 비용을 절감하세요.
</Callout>

<ChapterNav
  prev={{ title: '개발 환경 설정', path: '/docs/part-1--시작하기-개발-환경-설정' }}
  next={{ title: '릴리스 히스토리', path: '/docs/part-1--시작하기-릴리스-히스토리' }}
/>
