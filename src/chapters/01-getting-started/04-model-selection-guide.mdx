...
<ComparisonTable
  ...
  headers={['항목', 'Opus 4.6', 'Sonnet 4.6', 'Opus 4.5', 'Sonnet 4.5', 'Haiku 4.5']}
  rows={[
    { feature: '모델 ID', values: ['claude-opus-4-6', 'claude-sonnet-4-6', 'claude-opus-4-5-20251101', 'claude-sonnet-4-5-20250929', 'claude-haiku-4-5'] },
    { feature: '출시일', values: ['2026년 2월', '2026년 2월', '2025년 11월', '2025년 9월', '2025년 10월'] },
    { feature: '컨텍스트 윈도우', values: ['200K (1M 베타)', '200K (1M 베타)', '200K', '200K (1M 베타)', '200K'] },
    { feature: '최대 출력', values: ['128,000 토큰', '64,000 토큰', '64,000 토큰', '64,000 토큰', '64,000 토큰'] },
    { feature: '입력 가격 (/1M 토큰)', values: ['$5', '$3', '$5', '$3', '$1'] },
    { feature: '출력 가격 (/1M 토큰)', values: ['$25', '$15', '$25', '$15', '$5'] },
    ...
    { feature: '강점', values: ['Agent Teams, 1M 컨텍스트, 적응형 사고', 'Opus급 성능, Sonnet 가격, 컴퓨터 사용', '깊은 추론, 아키텍처', '균형 잡힌 성능', '빠른 속도, 저비용'] },
  ]}
/>
...
<Callout type="tip" title="Sonnet 4.6 vs Opus 4.6">
  Claude Code 사용자의 **70%가 Sonnet 4.5보다 Sonnet 4.6을 선호**하며,
  심지어 **59%가 Opus 4.5보다도 Sonnet 4.6을 선호**합니다.
  Agent Teams가 필요하지 않은 대부분의 작업에서 Sonnet 4.6은 최적의 선택입니다.
</Callout>
...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: 'Sonnet 4.5', values: ['77.2%', '중간', '검증된 안정성. 이전 세대 Sonnet'] },
...
<ComparisonTable
  title="주요 벤치마크 종합 비교 (2026년 3월 기준)"
  headers={['벤치마크', 'Opus 4.6', 'Sonnet 4.6', 'Sonnet 4.5', 'Haiku 4.5', '측정 영역']}
  rows={[
    { feature: 'SWE-bench Verified', values: ['80.8%', '79.6%', '77.2%', '73.3%', '실제 GitHub 이슈 해결'] },
    { feature: 'GPQA Diamond', values: ['91.3%', '89.9%', '83.4%', '-', '대학원 수준 과학/수학'] },
    { feature: 'MATH-500', values: ['97.6%', '97.8%', '96.4%', '-', '수학 문제 풀이'] },
    { feature: 'tau2-bench Retail', values: ['91.9%', '91.7%', '86.2%', '-', '에이전트 도구 사용 (소매)'] },
    { feature: 'tau2-bench Telecom', values: ['99.3%', '97.9%', '98.0%', '-', '에이전트 도구 사용 (통신)'] },
    { feature: 'OSWorld-Verified', values: ['72.7%', '72.5%', '61.4%', '-', '컴퓨터 사용 (데스크톱 자동화)'] },
  ]}
/>
...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: 'Effort 파라미터', values: ['3단계 (low/medium/high)', '3단계 (low/medium/high, 2026년 3월 기준 max 제거)'] },
...
Opus 4.6의 Adaptive Thinking은 **Effort 파라미터**를 통해 사고 깊이를 3단계로 제어할 수 있습니다. 2026년 3월 업데이트에서 기존 4단계(low/medium/high/max)가 3단계(low/medium/high)로 간소화되었습니다. Claude Code에서는 이것이 자동으로 적용되지만, API 사용 시 명시적으로 설정할 수 있습니다. Opus 4.6은 Max/Team 구독자에게 기본 medium effort로 설정됩니다.
...
<Callout type="tip" title="Claude Code의 Effort 조절">
  ...
  2026년 3월부터 effort는 low/medium/high 3단계로 간소화되었으며, 기존 max 단계는 high에 통합되었습니다.
</Callout>
...
<ComparisonTable
  title="모델별 토큰 비용 상세"
  headers={['비용 항목', 'Opus 4.6', 'Sonnet 4.6', 'Sonnet 4.5', 'Haiku 4.5', '비고']}
  rows={[
...
<ComparisonTable
  ...
  headers={['작업', '입력 토큰', '출력 토큰', 'Opus 4.6', 'Sonnet 4.6', 'Haiku 4.5']}
  rows={[
...
<ComparisonTable
  title="주요 AI 코딩 모델 비교 (2026년 3월 기준)"
  headers={['모델', 'SWE-bench', '컨텍스트', '강점', '약점']}
  rows={[
    { feature: 'Claude Opus 4.6', values: ['80.8%', '200K (1M 베타)', 'Agent Teams, Adaptive Thinking, 보안 분석', '비용이 높음'] },
    { feature: 'Claude Sonnet 4.6', values: ['79.6%', '200K (1M 베타)', 'Opus급 성능, Sonnet 가격, 컴퓨터 사용', 'Agent Teams 미지원'] },
    { feature: 'Claude Opus 4.5', values: ['80.9%', '200K', '단일 세션 최고 추론, 아키텍처', '멀티 에이전트 미지원'] },
    { feature: 'Claude Sonnet 4.5', values: ['77.2%', '200K (1M 베타)', '검증된 안정성', 'Sonnet 4.6에 의해 대체'] },
...
| 상황 | 모델 | 근거 |
|------|------|------|
| "잘 모르겠다" | Sonnet 4.6 | 기본값, 80%의 작업에서 최적 |
...
<Callout type="tip" title="세 가지 황금 규칙">
  ...
  2. **복잡한 추론은 Opus**: 아키텍처 설계, 보안 분석, 복잡한 디버깅, Agent Teams에는 Opus를 사용하세요.
