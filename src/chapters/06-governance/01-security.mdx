...
2026년 **[Top 10 for Agentic Applications](https://genai.owasp.org/resource/owasp-top-10-for-agentic-applications-for-2026/)**에서 에이전트 목표 탈취(Goal Hijack)를 1위로 선정했습니다.
...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: 'A03', values: ['소프트웨어 공급망 실패', '높음', '의존성 스캔 자동화, lock 파일 커밋'] },
    ...
    { feature: 'A08', values: ['데이터 무결성 실패', '중간', '서명 검증, 공급망 보안'] },
    { feature: 'A09', values: ['보안 로깅 및 알림 실패', '중간', '구조화된 로깅과 알림 구현'] },
    { feature: 'A10', values: ['예외 조건 처리 오류', '중간', '체계적 에러 핸들링 구현'] },
  ]}
/>
