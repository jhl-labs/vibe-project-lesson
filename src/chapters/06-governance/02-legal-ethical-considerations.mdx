...
| **2026년 8월 2일** | 전체 집행 권한 발효 (최대 3,500만 유로 또는 전세계 매출 7% 벌금 — 위반 유형별 차등) |
...
| **Thomson Reuters v. Ross** | AI 훈련 공정이용 항변 최초 기각 | Thomson Reuters 승소 (제3순회 항소법원 항소 계류 중) |
...
한국은 2025년 1월 **AI 기본법**이 제정(공포)되었으며, 1년의 유예 기간을 거쳐 **2026년 1월 22일 시행**됩니다. 특히 개발자가 주목해야 할 점은 다음과 같습니다.
...
3. **2025년**: 제9순회 항소법원에서 DMCA "동일성" 요건 쟁점 심리 중. 최종 판결이 AI 코딩 도구 산업 전체에 영향을 미칠 전망
...
| **CCPA** | 소비자 개인정보를 AI 서비스 제공자에게 공유 시 고지 의무. 삭제 요청 대응 필요 | 고의적 위반 건당 최대 $7,988 (2025년 CPI 조정 기준) |
...
- **Pro/Max 플랜 사용자**: 2025년 9월 28일부로 대화 내용이 모델 훈련에 **기본적으로 사용**됨 (사용자가 직접 [설정에서 opt-out](https://privacy.claude.com/en/articles/10023580-is-my-data-used-for-model-training) 필요)
- **API 사용자**: 입력/출력 데이터가 모델 훈련에 사용되지 않음 (이용약관 명시)
- **Enterprise 플랜**: 데이터 격리, SOC 2 준수, 맞춤형 데이터 보존 정책 적용 가능. 모델 훈련 미사용
- **데이터 보존**: API 사용 시 안전 평가 목적으로 최대 **7일** 보존 후 삭제 ([Anthropic Privacy](https://privacy.claude.com/en/articles/10023548-how-long-do-you-store-my-data)). 안전 정책 위반 플래그 시 최대 2년 보존
