...
<ComparisonTable
  ...
  headers={['판례', '법원/날짜', '결과']}
  rows={[
    { feature: 'Thaler v. Perlmutter', values: ['DC 순회 항소법원, 2025.03.18', '인간 저작자성은 저작권법의 법정 요건(statutory requirement)임을 확인. 원심 지지'] },
    { feature: 'Thomson Reuters v. Ross Intelligence', values: ['Delaware 연방지방법원, 2025.02 (제3순회 항소 계류 중)', 'AI 훈련 데이터의 공정이용 항변 최초 기각. Thomson Reuters 승소. 2025.09 항소심 개시'] },
    { feature: 'Doe v. GitHub (Copilot 소송)', values: ['제9순회 항소법원 계류 중 (2026.02 구두변론 예정)', 'DMCA §1202(b) "동일성" 요건 쟁점으로 항소 진행 중'] },
  ]}
/>
...
AI-assisted: Claude Code (Opus 4.8)로 초기 구현 후 수정"
...
| 시점 | 내용 |
|------|------|
| **2025년 8월 2일** | GPAI(범용 AI) 제공자 의무 발효. 이후 출시 모델은 즉시 준수 필요 |
| **2026년 8월 2일** | 전체 집행 권한 발효 — AI Office의 벌금 부과, 모델 리콜, 완화 조치 명령 가능. Article 50 투명성 의무 등 대부분의 조항이 전면 적용 (최대 3,500만 유로 또는 전세계 매출 7% 벌금 — 위반 유형별 차등) |
| **2027년 8월 2일** | 2025년 8월 이전 출시 GPAI 모델에도 준수 의무 적용 (2년 유예 종료) |
...
| 사건 | 내용 | 금액/결과 |
|------|------|-----------|
| **Bartz v. Anthropic** | 미국 저작권 역사상 최대 규모 AI 관련 합의. Anthropic이 해적판 도서관(LibGen, PiLiMi)에서 ~50만 권을 다운로드하여 AI 훈련에 사용한 혐의. Anthropic은 해당 데이터 파기 의무 | $15억 합의 (2025.08 예비 승인, 2026.04 최종 심리 예정) |
| **Warner Music v. Suno/Udio** | 음악 AI 저작권 분쟁. WMG가 Suno(2025.11.25)·Udio(2025.11.19)와 각각 별도 라이선스 합의. Sony는 미합의로 소송 계속 | 비공개 라이선스 합의 (2026년 신규 라이선스 모델 기반 플랫폼 출시 예정) |
| **Thomson Reuters v. Ross** | AI 훈련 공정이용 항변 최초 기각. 법원은 Ross의 사용이 "변환적 이용"에 자동 해당하지 않는다고 판시 | Thomson Reuters 승소 (제3순회 항소법원 항소 계류 중, 2025.09 항소심 개시) |
...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: '주요 규제 동향', values: [
      ...
      'AI 기본법 (2025.01 제정, 2026.01 시행), 저작권법 개정 논의 중',
...
한국은 2025년 1월 **AI 기본법**(정식 명칭: 인공지능 발전과 신뢰 기반 조성 등에 관한 기본법)이 제정(공포)되었으며, 1년의 유예 기간을 거쳐 **2026년 1월 22일 시행**되었습니다. EU에 이어 세계에서 두 번째로 포괄적 AI 규제 프레임워크를 채택한 국가입니다. 특히 개발자가 주목해야 할 점은 다음과 같습니다.
...
- **AI 기본법 주요 내용**: 고영향(High-Impact) AI, 고성능(High-Performance, 10²⁶ FLOP 이상) AI, 생성형 AI에 대한 차등 규제. AI 시스템의 투명성, 안전성, 공정성에 관한 기본 원칙 규정. 생성형 AI 생성물에 대한 라벨링 의무 포함. 과학기술정보통신부(MSIT)가 관할 기관으로 지정
- **유예 기간**: 행정 과태료 부과 전 최소 1년의 유예 기간을 두어 기업의 준비 시간을 확보. MSIT가 법률 지원 데스크와 가이드라인을 운영 중
...
2. **2024년 6월**: DMCA 관련 청구도 기각 (AI 출력이 원본과 동일할 것을 요구). 동년 9월 연방지방법원이 제9순회 항소법원으로의 중간 항소를 인증(certify)
3. **2025-2026년**: 제9순회 항소법원에서 DMCA §1202(b)(1) 및 (b)(3)의 "동일성(identicality)" 요건 쟁점 심리 중. 2026년 2월 샌프란시스코 구두변론 일정이 예정되어 있으며, 최종 판결이 AI 코딩 도구 산업 전체에 영향을 미칠 전망
...
2025년 8월 합의된 이 사건은 AI 회사의 훈련 데이터 사용에 대한 저작권 리스크가 얼마나 큰지를 보여주는 대표적 사례입니다.
논픽션 작가 Charles Graeber, Kirk Wallace Johnson, 스릴러 작가 Andrea Bartz가 제기한 집단소송으로,
Anthropic이 Library Genesis(LibGen)와 PiLiMi 같은 "그림자 도서관"에서 약 50만 권의 저작물을 다운로드하여
AI 훈련에 사용했다는 혐의입니다. 미국 저작권 역사상 AI 관련 최대 규모의 합의($15억, 저작물당 약 $3,000)로,
Anthropic은 해당 도서관의 데이터와 파생 복사본을 30일 내 파기해야 합니다.
2025년 9월 25일 Alsup 판사가 예비 승인했으며, 2026년 4월 최종 심리(fairness hearing)가 예정되어 있습니다.
이 합의가 Anthropic에게 향후 저작물 사용 라이선스를 부여하는 것은 아닙니다.

### Thomson Reuters v. Ross Intelligence (공정이용 기각)

이 판결은 AI 훈련에서의 공정이용(Fair Use) 항변이 처음으로 기각된 사례입니다.
법원은 Ross Intelligence가 2,243개의 Westlaw 헤드노트를 재현했다고 인정하며 다음과 같이 판시했습니다.

- AI 모델 훈련을 위한 저작물 사용은 **변환적 이용(transformative use)**에 자동으로 해당하지 않음 (Andy Warhol Foundation v. Goldsmith 기준 적용)
- Ross의 사용은 Westlaw과 **직접 경쟁하는 도구**를 만들기 위한 것으로, 원저작물의 **시장 대체 가능성**이 핵심
- 훈련 데이터 사용의 **상업적 목적**이 공정이용 항변을 약화시킴

2025년 5월 지방법원이 중간 항소를 허가하고, 9월 Ross가 제3순회 항소법원에 항소심 준비서면을 제출했습니다.
이 사건은 **항소법원 수준에서 AI 공정이용을 판단하는 최초의 사례**가 될 전망입니다.
...
| **CCPA** | 소비자 개인정보를 AI 서비스 제공자에게 공유 시 고지 의무. 삭제 요청 대응 필요 | 일반 위반 건당 $2,663, 고의적 위반 건당 최대 $7,988 (2025년 CPI 조정, 2026년까지 유효) |
...
- **Free/Pro/Max 플랜 사용자**: 2025년 8월 28일 정책 변경 발표, 사용자에게 데이터 사용 여부 선택권 부여. 모델 훈련 허용 시 대화/코딩 세션 데이터가 비식별화되어 최대 **5년** 보존. 미허용 시 기존 **30일** 보존 정책 유지. [설정에서 언제든 변경 가능](https://privacy.claude.com/en/articles/10023580-is-my-data-used-for-model-training). Claude Code도 해당 계정 플랜 정책을 따름
- **API 사용자**: 입력/출력 데이터가 모델 훈련에 사용되지 않음. 2025년 9월 15일부터 안전 평가 목적 보존 기간이 30일에서 **7일**로 단축 ([Anthropic Privacy](https://privacy.claude.com/en/articles/10023548-how-long-do-you-store-my-data))
- **Commercial Terms (Claude for Work/Government/Education/API)**: 소비자 정책 변경 적용 대상이 아님. 모델 훈련 미사용
- **Enterprise 플랜**: 데이터 격리, SOC 2 준수, 맞춤형 데이터 보존 정책 적용 가능. 선택적 Zero-Data-Retention(ZDR) 부속 계약 가능
