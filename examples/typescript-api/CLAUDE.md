...
Express + Jest 기반 Clean Architecture API (InMemory 저장소)
...
infrastructure/persistence/
  in-memory-user-repository.ts  # InMemory 구현체
...
- 통합 테스트: supertest로 HTTP 엔드포인트 테스트
